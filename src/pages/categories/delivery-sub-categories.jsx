...
import { deliverySubCategory } from "@/store/SubCategoriesSlice";
...
const Page = () => {
  ...
  useEffect(() => {
    dispatch(deliverySubCategory());
  }, []);

  return (
    <>
      <Head>
        <title>{`${process.env.APP_NAME} | Delivery Sub Category`}</title>
      </Head>
      <Box
        component="main"
        sx={{
